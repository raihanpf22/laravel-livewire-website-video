<div>
    ...
    <div style="margin-bottom: 50px">
        <div class="container-fluid" style="margin-top:80px">
            <div class="row mb-3">
                <div class="col-md-12">
                    <a href="" class="badge badge-secondary bg-light text-dark shadow-sm mb-2" style="font-size: 18px; border-radius: 16px;">
                    All Playlist</a>
                    @foreach($playlists as $playlist)
                    <a href="{{ route('frontend.playlists.show', $playlist->slug) }}" class="badge badge-secondary shadow-sm mb-2" style="font-size: 18px; border-radius: 16px;">
                    {{ $playlist->title }}</a>
                    @endforeach
                </div>
            </div>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 border-0 rounded shadow-sm">
                        ...
                        <div class="card-footer" style="background-color: rgb(255, 255, 255); border: none;">
                            ...
                            Views {{ $video->created_at->diffForHumans() }}
                        </div>
                    </div>
                </div>
                @endforeach
