        ...
        <div class="col-md-8">
            ...
            <div class="card border-0 rounded shadow-sm mb-3">
                <div class="card-body">
                    ...
                    <p>
                        {{ $video_play->views }} Views 
                        {{ $video_play->created_at->diffForHumans() }}
                    </p>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-10 col-md-11">
                            ...
                            <strong>
                                {{ App\Video::where('user_id', $video_play->user->id)->count() }}
                            </strong> Videos
                            </p>
                            <p class="mt-4">
                            {!! $video_play->content !!}
        ...
        <div class="col-md-4">
            <div class="card border-0 rounded shadow-sm mb-3">
                ...
                <a href="{{ route('frontend.playlists.show', $segment.'?id='.$video->id) }}" class="text-dark text-decoration-none">
                    <div class="media">
                        <img class="align-self-center mr-2" src="{{ Storage::url('public/videos/'.$video->image) }}" width="120" height="80">
