            ...
            <div class="col-md-4">
                ...
                <div class="card border-0 rounded shadow-sm mb-3">
                    <a href="{{ route('frontend.videos.show', $video->slug) }}" class="text-dark text-decoration-none">
                        <div class="media">
                            <img class="align-self-center mr-2" src="{{ Storage::url('public/videos/'.$video->image) }}" width="200" height="130">
                            <div class="media-body">
                                <h6 class="mt-2 mr-1 font-weight-bold">{{ $video->title }}</h6>
                                <p class="mb-0">{{ $video->user->nama }} </p>
                                <p>
