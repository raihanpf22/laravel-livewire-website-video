        ...
        <div class="card-body">
            <form wire:submit.prevent="store">
                ...
                <div class="form-group" wire:ignore>
                    ...
                    <textarea class="from-control @error('content') is-invalid @enderror" id="content" name="content" placeholder="Masukan deskripsi video" rows="4" wire:model.lazy="content">{{ $content }}</textarea>
                    @error('content')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
