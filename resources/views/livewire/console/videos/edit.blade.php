        ...
        <div class="card border-0 rounded-lg shadow-sm">
            ...
            <div class="card-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group">
                        <label>TITLE</label>
                        <input type="text" class="form-control @error('title') is-invalid @enderror" wire:model.lazy="title" placeholder="Masukan judul video">
                        @error('title')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('embed_youtube') is-invalid @enderror" wire:model.lazy="embed_youtube" placeholder="Masukan url video">
                                @error('embed_youtube')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group" wire:ignore>
                        ...
                        <textarea class="from-control @error('content') is-invalid @enderror" id="content" name="content" placeholder="Masukan deskripsi video" rows="4" wire:model.lazy="content">
                            {{ $content }}
                        </textarea>
                        @error('content')
                        <div class="invalid-feedback">
